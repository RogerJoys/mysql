...
EOSQL
    ...
    class Pkginfo
      def self.pkginfo
        ...
        @pkginfo.set['debian']['16.04']['5.6']['client_package'] = %w(mysql-client-5.6 libmysqlclient-dev)
        ...
        # @pkginfo.set['omnios']['151014']['5.5']['client_package'] = %w(database/mysql-55/library)
        # @pkginfo.set['omnios']['151014']['5.5']['server_package'] = 'database/mysql-55'
        # @pkginfo.set['omnios']['151014']['5.6']['client_package'] = %w(database/mysql-56)
        # @pkginfo.set['omnios']['151014']['5.6']['server_package'] = 'database/mysql-56'
        # @pkginfo.set['omnios']['151018']['5.5']['client_package'] = %w(database/mysql-55/library)
        # @pkginfo.set['omnios']['151018']['5.5']['server_package'] = 'database/mysql-55'
        # @pkginfo.set['omnios']['151018']['5.6']['client_package'] = %w(database/mysql-56)
        # @pkginfo.set['omnios']['151018']['5.6']['server_package'] = 'database/mysql-56'
        ...
        @pkginfo.set['rhel']['7']['5.6']['client_package'] = %w(MySQL-client-advanced)
